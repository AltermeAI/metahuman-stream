...
if __name__ == '__main__':
    ...
    parser.add_argument('--push_url', type=str, default='http://localhost:1985/rtc/v1/whip/?app=live&stream=livestream&eip=192.168.86.2:8000') #rtmp://localhost/live/livestream
